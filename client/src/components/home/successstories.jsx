...
//     return (
//       <div>
//         <div className="bg-[#f8f8ff] py-12 md:px-20 font-inter text-[#1B084C]">
//           {/* Heading */}
//           <motion.div
...
//             </h2>
//             <p className=" mt-2">
//               Real results from real companies. See how we’ve helped
//               organizations <br className="hidden md:block" /> transform their
//               hiring process
//             </p>
//           </motion.div>
...
//             <motion.div
//               key={index}
//               className="flex flex-col md:flex-row items-center md:items-start gap-12 py-10 px-4 border-b border-[#D5CDFF]"
...
//                 viewport={{ once: true }}
//               >
//                 <h3 className="text-3xl font-bold  mb-6 font-museo">
//                   {story.title}
//                 </h3>
...
//                       <motion.div
//                         key={idx}
//                         className="bg-purple-50 px-4 py-3 rounded-lg shadow-sm"
...
//                 {/* Client Testimonial */}
//                 <div className="text-center mt-10 flex justify-between">
//                   <h4 className="text-lg font-bold ">Client Testimonial</h4>
//                   <motion.span
//                     className="inline-block text-gray-500 text-xl mt-2"
//                     animate={{ y: [0, 5, 0] }}
