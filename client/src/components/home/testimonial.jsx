...
// ✅ Helper: convert HTML string to plain text & handle line breaks
  ...
  const defaultone = [
    {
      ...
      heading: "Rajesh Kumar",
      message:
        "The Pay Per Hire model was perfect for our startup phase.\nWe got access to top-tier talent without the financial risk of traditional recruitment agencies.",
    },
    {
      _id: 2,
      banner: "/images/cliimg2.png",
      heading: "Apeksha Agarwal",
      message:
        "Jobs Territory made our dermatologist hiring seamless and quick.\nTheir team understood our needs and delivered quality candidates on time.",
    },
  ];
