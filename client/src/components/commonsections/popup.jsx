...
const RecruiterPopup = ({ isOpen, onClose }) => {
  useEffect(() => {
    ...
    document.documentElement.style.overflowY = "scroll"; // reserve scrollbar space
    document.body.style.overflow = "hidden";
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/40 backdrop-blur-sm text-[#1B084C]">
      <div
        style={{
          backgroundImage: "url('/images/popupbg.png')",
          backgroundSize: "cover",
          backgroundPosition: "center",
          boxShadow: "0 4px 6px -4px rgba(0,0,0,0.1)",
        }}
        className=" rounded-xl shadow-lg p-8 sm:p-10 md:p-12 w-[90%] max-w-4xl relative "
      >
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <form className="space-y-4 w-[90%] md:w-[75%] my-2 mx-auto" onSubmit={handleSubmit}>
 ...
 justify-center items-center"
          >
            <button
              type="submit"
              disabled={loading}
              className="px-3 bg-[#1B084C] text-white py-2 rounded-md hover:bg-indigo-800 transition disabled:opacity-50"
            >
